    ...
    public function render_job_column(string $column, int $post_id): void
    {
        switch ($column) {
            ...
            case 'location':
                ...
                $debug_opts = get_option('careernest_options', []);
                $show_coords = isset($debug_opts['debug_show_coordinates']) && $debug_opts['debug_show_coordinates'] === '1';
                ...
                if ($location) {
                    ...
                    if ($show_coords) {
                        ...
                        if ($lat && $lng) {
                            ...
                            echo esc_html(number_format((float) $lat, 6)) . ', ' . esc_html(number_format((float) $lng, 6));
                            echo '</span>';
                        } else {
                            echo '<span style="font-size: 11px; color: #c62828; font-family: monospace;">NO COORDS</span>';
                        }
                    }
                } else {
                    echo '&mdash;';
