...
?>
        <script>
            ...
            function initApplicantAutocomplete() {
            ...
            if (typeof google !== 'undefined') {
                initApplicantAutocomplete();
            } else {
                window.initApplicantAutocomplete = initApplicantAutocomplete;
            }
        </script>
...
<?php
        ...
        wp_enqueue_script(
            'google-maps-applicant',
            'https://maps.googleapis.com/maps/api/js?key=' . urlencode($maps_api_key) . '&libraries=places&callback=initApplicantAutocomplete',
            [],
            null,
            true
        );
