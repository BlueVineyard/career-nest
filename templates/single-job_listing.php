                ...
                if ($related_jobs->have_posts()): ?>
                    <div class="cn_related-jobs-list">
                        <?php while ($related_jobs->have_posts()): $related_jobs->the_post();
                            ...
                            $related_employer_id = $related_employer_id ? (int) $related_employer_id : 0;

                            // Verify employer post exists before getting data
                            $related_company = '';
                            $related_employer_logo = '';
                            if ($related_employer_id && get_post_status($related_employer_id)) {
                                $related_company = get_the_title($related_employer_id);
                                $related_employer_logo = get_the_post_thumbnail_url($related_employer_id, 'thumbnail');
                            }
